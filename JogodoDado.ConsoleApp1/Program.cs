...
class Program
{
    static int ExecutarRodadadoJogador(int Player, int roldado, int roldado3)
    {
    ...
    static int ExecutarRodadaMaquina(int Maquina, int roldado2, int roldado4)
    {
    ...
    static void Main(string[] args)
    {
        ...
        while (true == true)
        {
            ...
            Player = ExecutarRodadadoJogador(Player, roldado, roldado3);
            Console.ReadLine();
            Maquina = ExecutarRodadaMaquina(Maquina, roldado2, roldado4);
